...
app=FastAPI(title=settings.app_name,version="0.2.0-beta",lifespan=lifespan)
...
@app.get("/health")
def health():
    return {"status":"ok","service":"AQ Backend","version":"0.2.0-beta","environment":settings.environment,"sports_api_configured":bool(settings.sports_api_key),"ai_api_configured":bool(settings.openai_api_key),"sync_mode":settings.sync_mode}
